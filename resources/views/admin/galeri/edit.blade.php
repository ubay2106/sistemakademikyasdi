    ...
    <div class="max-w-xl space-y-6">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 mt-0.5">Perbarui informasi dan foto galeri sekolah.</p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <form action="{{ route('admin.galeri.update', $galeri->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="space-y-1.5">
                    <label class="block text-xs font-semibold text-gray-600 uppercase tracking-wide">
                        Upload Foto <span class="text-gray-400 font-normal normal-case">(Kosongkan jika tidak ingin mengganti)</span>
                    </label>
                    ...
                    <label for="foto-input"
                        ...
                        {{-- Preview (tampil foto lama secara default jika ada) --}}
                        @if ($galeri->foto)
                            <img id="foto-preview" src="{{ asset('storage/' . $galeri->foto) }}" alt="Preview"
                                class="absolute inset-0 w-full h-full object-cover rounded-2xl">
                            <div id="drop-overlay" class="absolute inset-0 rounded-2xl flex items-center justify-center"
                                style="background: rgba(0,0,0,0.45);">
                                <span class="text-white text-xs font-semibold">Klik untuk ganti foto</span>
                            </div>
                            <div id="drop-placeholder" class="flex flex-col items-center gap-2 pointer-events-none hidden">
                        @else
