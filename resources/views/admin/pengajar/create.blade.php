...
@section('content')
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h1 class="text-lg font-bold text-gray-800">Tambah Pengajar</h1>
            <p class="text-xs text-gray-400 mt-0.5">Tetapkan guru untuk mengajar kelas dan mata pelajaran tertentu</p>
        </div>
    </div>
        ...
        <form method="POST" action="{{ route('admin.pengajar.store') }}">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 overflow-hidden">
                ...
                <div class="px-6 py-5 border-b border-gray-50 flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-sm font-semibold text-gray-700">Informasi Penugasan</h2>
                        <p class="text-xs text-gray-400 mt-0.5">Kombinasi guru, kelas, mapel, dan tahun ajaran harus unik
                        </p>
                    </div>
                </div>
                ...
                <div class="px-6 py-6 space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <div
                                class="absolute left-3.5 top-1/2 -translate-y-1/2 w-5 h-5 rounded-md bg-blue-50 flex items-center justify-center pointer-events-none">
                                <svg class="w-3 h-3 text-blue-400" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round"
    ...
    {{ $errors->has('guru_id') ? 'border-red-300 bg-red-50' : 'border-gray-200 bg-gray-50' }}">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <div
                                    class="absolute left-3.5 top-1/2 -translate-y-1/2 w-5 h-5 rounded-md bg-indigo-50 flex items-center justify-center pointer-events-none">
                                    <svg class="w-3 h-3 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                        stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round"
    ...
    {{ $errors->has('kelas_id') ? 'border-red-300 bg-red-50' : 'border-gray-200 bg-gray-50' }}">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <div
                                    class="absolute left-3.5 top-1/2 -translate-y-1/2 w-5 h-5 rounded-md bg-violet-50 flex items-center justify-center pointer-events-none">
                                    <svg class="w-3 h-3 text-violet-400" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                        stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round"
    ...
    {{ $errors->has('mata_pelajaran_id') ? 'border-red-300 bg-red-50' : 'border-gray-200 bg-gray-50' }}">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <div
                                class="absolute left-3.5 top-1/2 -translate-y-1/2 w-5 h-5 rounded-md bg-amber-50 flex items-center justify-center pointer-events-none">
                                <svg class="w-3 h-3 text-amber-400" fill="none" viewBox="0 0 24 24" stroke-width="2"
                                    stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round"
    ...
    {{ $errors->has('tahun_ajaran_id') ? 'border-red-300 bg-red-50' : 'border-gray-200 bg-gray-50' }}">
                    ...
                    {{-- Status Aktif --}}
                    <div
                        class="flex items-center justify-between py-3.5 px-4 bg-gray-50 rounded-xl border border-gray-100">
                        <div>
                    ...
                    <div class="flex items-start gap-2.5 bg-amber-50 border border-amber-100 rounded-xl px-4 py-3">
                        <svg class="w-4 h-4 text-amber-400 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24"
                            stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M11.25 11.25l.041-.02a.75.75 0 0 1 1.063.852l-.708 2.836a.75.75 0 0 0 1.063.853l.041-.021M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9-3.75h.008v.008H12V8.25Z" />
                        </svg>
                        <p class="text-xs text-amber-700 leading-relaxed">
                            Kombinasi <strong>guru, kelas, mata pelajaran, dan tahun ajaran</strong> yang sama tidak dapat
                            diduplikat.
                        </p>
                    </div>
