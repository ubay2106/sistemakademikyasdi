...
<div class="flex items-center gap-3 mb-6">
    ...
    <div>
        <h1 class="text-lg font-bold text-gray-800 leading-none">Tambah Tahun Ajaran</h1>
        <p class="text-xs text-gray-400 mt-0.5">Buat tahun ajaran baru</p>
    </div>
</div>
            ...
            <div class="bg-amber-50 rounded-2xl border border-amber-100 p-5">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-amber-600 leading-relaxed">Hanya boleh ada <strong>satu</strong> tahun ajaran yang aktif dalam satu waktu. Mengaktifkan tahun ajaran baru akan menonaktifkan yang lain secara otomatis.</p>
                    </div>
                </div>
            </div>
