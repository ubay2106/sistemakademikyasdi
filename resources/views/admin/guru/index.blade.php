...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
    ...
    <div class="bg-white rounded-xl border border-gray-100 px-4 py-3 flex items-center gap-3">
        ...
        <div>
            <p class="text-lg font-bold text-gray-800 leading-none">{{ \App\Models\Guru::where('jenis_kelamin','L')->count() }}</p>
            <p class="text-xs text-gray-400 mt-0.5">Laki-laki</p>
        </div>
    </div>
    <div class="bg-white rounded-xl border border-gray-100 px-4 py-3 flex items-center gap-3">
        <div class="w-9 h-9 rounded-lg bg-pink-50 flex items-center justify-center">
            <svg class="w-4 h-4 text-pink-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
            </svg>
        </div>
        <div>
            <p class="text-lg font-bold text-gray-800 leading-none">{{ \App\Models\Guru::where('jenis_kelamin','P')->count() }}</p>
    ...
    <div class="bg-white rounded-xl border border-gray-100 px-4 py-3 flex items-center gap-3">
        ...
        <div>
            <p class="text-lg font-bold text-gray-800 leading-none">{{ \App\Models\Guru::whereHas('user', fn($q) => $q->where('is_active', true))->count() }}</p>
        ...
        <table class="w-full">
            <thead>
                <tr class="border-b border-gray-100 bg-gray-50/70">
                    ...
                    <th class="text-left text-xs font-semibold text-gray-400 uppercase tracking-wider px-4 py-4 hidden md:table-cell">NIP</th>
                    <th class="text-left text-xs font-semibold text-gray-400 uppercase tracking-wider px-4 py-4 hidden lg:table-cell">Kontak</th>
                    <th class="text-left text-xs font-semibold text-gray-400 uppercase tracking-wider px-4 py-4 hidden lg:table-cell">Akun Login</th>
                ...
                <tr class="hover:bg-gray-50/50 transition group">
                    ...
                    <td class="px-4 py-4 hidden lg:table-cell">
                        ...
                        @if($guru->tempat_lahir && $guru->tanggal_lahir)
                            <p class="text-xs text-gray-400 mt-0.5">{{ $guru->tempat_lahir }}, {{ \Carbon\Carbon::parse($guru->tanggal_lahir)->isoFormat('D MMM Y') }}</p>
                        @endif
                    </td>
