...
@section('content')
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h1 class="text-lg font-bold text-gray-800 leading-none">Tambah Siswa</h1>
            <p class="text-xs text-gray-400 mt-0.5">Isi data siswa baru</p>
        </div>
    </div>
                        ...
                        @foreach ($statuses as $value => $s)
                            <label class="cursor-pointer block">
                                <input type="radio" name="status" value="{{ $value }}" class="peer hidden"
                                    {{ old('status', 'aktif') === $value ? 'checked' : '' }}>
                ...
                <div class="bg-blue-50 rounded-2xl border border-blue-100 p-5">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-blue-600 leading-relaxed">NIS harus unik dan tidak boleh sama dengan
                                siswa lain. Pastikan data yang dimasukkan sudah benar sebelum menyimpan.</p>
                        </div>
                    </div>
                </div>
