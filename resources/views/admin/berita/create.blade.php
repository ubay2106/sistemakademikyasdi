...
<div class="flex items-center gap-3 mb-6">
    ...
    <div>
        <h1 class="text-lg font-bold text-gray-800 leading-none">Tambah Berita</h1>
        <p class="text-xs text-gray-400 mt-0.5">Buat berita baru untuk dipublikasikan</p>
    </div>
</div>
        ...
        <div class="lg:col-span-2 space-y-5">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 p-6">
                ...
                <textarea id="ringkasan" name="ringkasan" rows="3"
                    ...
                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary focus:bg-white transition resize-none">{{ old('ringkasan') }}</textarea>
                @error('ringkasan')
                    <p class="text-xs text-red-500 mt-1.5">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 p-6">
                ...
                <textarea id="isi" name="isi" rows="14"
                    ...
                    class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary focus:bg-white transition resize-y">{{ old('isi') }}</textarea>
                @error('isi')
                    <p class="text-xs text-red-500 mt-1.5">{{ $message }}</p>
                @enderror
            </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea id="meta_description" name="meta_description" rows="2"
                            ...
                            class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary focus:bg-white transition resize-none">{{ old('meta_description') }}</textarea>
                    ...
                    <label class="flex items-center gap-3 cursor-pointer group">
                        <div class="relative">
                            <input type="checkbox" id="is_featured" name="is_featured" value="1"
                                class="peer sr-only" {{ old('is_featured') ? 'checked' : '' }}>
                ...
                <select name="berita_kategori_id"
                    ...
                    @foreach($kategoris as $kategori)
                        <option value="{{ $kategori->id }}"
                            {{ old('berita_kategori_id') == $kategori->id ? 'selected' : '' }}>
                            {{ $kategori->nama }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="bg-white rounded-2xl border border-gray-100 p-6">
                ...
                <label id="upload-label" for="gambar_utama"
                    ...
                    <div class="text-center">
                        <p class="text-sm font-medium text-gray-600 group-hover:text-primary transition">Klik untuk unggah</p>
                ...
                {{-- Caption --}}
                <div class="mt-3">
                    <input type="text" name="caption_gambar" value="{{ old('caption_gambar') }}"
