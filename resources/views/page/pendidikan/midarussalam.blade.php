...
@section('content')
        ...
        <div class="relative container mx-auto px-6">
            <div class="flex flex-wrap items-center justify-between gap-10">
                ...
                <div class="w-full flex justify-center lg:hidden mb-4">
                    <img src="{{ asset('img/mi.png') }}" alt="Logo" class="max-w-[150px]">
                </div>
                ...
                <div class="hidden lg:flex w-1/3 justify-center items-center">
                    <div class="relative flex items-center justify-center">
                        ...
                        <div class="w-52 h-52 rounded-full flex items-center justify-center"
                            ...
                            <img src="{{ asset('img/mi.png') }}" alt="Logo" class="max-w-[170px]">
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-14 pt-8 grid grid-cols-2 lg:grid-cols-4 gap-0"
                ...
                <div class="text-center px-4 py-2" style="border-right: 1px solid rgba(255,255,255,0.1);">
                    <p class="text-green-400 text-2xl font-bold">70+</p>
    ...
    <section id="visi-misi" class="relative py-24 overflow-hidden">
        <div class="absolute inset-0">
            <img src="{{ asset('img/MI1.jpeg') }}" alt="Background" class="w-full h-full object-cover object-center">
            ...
            <div class="flex flex-col lg:flex-row gap-8 max-w-5xl mx-auto">
                ...
                <div
                    ...
                    <p class="text-white/90 text-base leading-relaxed">
                        Menjadi madrasah unggul dalam bentuk generasi
                        <span class="font-bold text-green-300">Islami yang Taqwa</span>,
                        <span class="font-bold text-green-300">Berakhlaqul Karimah</span>,
                        <span class="font-bold text-green-300">Cerdas dan Terampil</span>, dan
                        <span class="font-bold text-green-300">Siap menghadapi tantangan masa deopan melalui pembelajaran mendalam</span> dan
                        <span class="font-bold text-green-300">berlandaskan nilai-nilai rahmatan lil-alamin</span>
                    </p>
                </div>
                ...
                <div
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start gap-3 text-white/90 text-base leading-relaxed">
                            ...
                            Menyeleggarakan pembelajaran Aktif, kreatif, efektif dan menyenangkan yang mendorong deep learning dan keterampilan abad 21.
                        </li>
                        <li class="flex items-start gap-3 text-white/90 text-base leading-relaxed">
                            <span class="mt-1.5 flex-shrink-0 w-2 h-2 rounded-full bg-green-400"></span>
                            Memberikan bimbingan dan pembinaan untuk mengembangkan potensi dan kreatifitas Anak Didik.
                        </li>
                        <li class="flex items-start gap-3 text-white/90 text-base leading-relaxed">
                            <span class="mt-1.5 flex-shrink-0 w-2 h-2 rounded-full bg-green-400"></span>
                            Menumbuhkan karakter peserta didik melalui pembiasaan "7 kebiasaan Anak Indonesia Hebat".
                        </li>
                        <li class="flex items-start gap-3 text-white/90 text-base leading-relaxed">
                            <span class="mt-1.5 flex-shrink-0 w-2 h-2 rounded-full bg-green-400"></span>
                            Menginternalisasikan nilai kasih sayang dan kepedulian melalui Kurikulum cinta dalam seluruh aktivitas madrasah.
                        </li>
                        <li class="flex items-start gap-3 text-white/90 text-base leading-relaxed">
                            <span class="mt-1.5 flex-shrink-0 w-2 h-2 rounded-full bg-green-400"></span>
                            Meningkatkan penghayatan dan pengalaman nilai-nilai agama, moral dan budaya serta kesadaran peserta didik terhadap pentingnya menjaga diri dan memahami kesehatan reproduksi serta seksualitas sesuai ajaran islam.
                        </li>
                        <li class="flex items-start gap-3 text-white/90 text-base leading-relaxed">
                            <span class="mt-1.5 flex-shrink-0 w-2 h-2 rounded-full bg-green-400"></span>
                            Menguatkan kemitraan dengan orang tua dan masyarakat dalam mendukung pendidikin hoolistik.
                        </li>
                    </ul>
                </div>
